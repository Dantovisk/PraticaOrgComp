...
total_gelos1: var #3
	static total_gelos1 + #0, #'2' ; digito 0
	static total_gelos1 + #1, #'4' ; digito 1
	static total_gelos1 + #2, #'\0' ; null terminator
...
total_gelos2: var #3
	static total_gelos2 + #0, #'7' ; digito 0
...
total_gelos3: var #4
	static total_gelos3 + #0, #'1' ; digito 0
	static total_gelos3 + #1, #'0' ; digito 1
	static total_gelos3 + #2, #'1' ; digito 2
	static total_gelos3 + #3, #'\0' ; null terminator
